			...
			<div class="row">
				...
				<div class="col-mb-6">
					<ol class="breadcrumb float-sm-end">
						<!-- <a href="<?= base_url('Produk/Create') ?>" class="btn btn-default">
			...
			<div class="card-body">
					...
					<div class="modal-dialog modal-dialog-scrollable modal-xs">
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title fs-5" id="ProdukModalLabel">Tambah Produk</h4>
				...
				<tr class="align-middle">
					...
					<td>
						...
						<button class="btn btn-primary" data-target="#ProdukModal<?= $p->ProdukID ?>"
							data-toggle="modal">Edit</button>
						<!-- </a> -->
						<a onclick="return confirm('Apakah Anda Ingin Mengapus Data Produk')"
							href="<?= base_url('Produk/Hapus/' . $p->ProdukID) ?>">
				...
				<div class="modal fade" id="ProdukModal<?= $p->ProdukID ?>" tabindex="-1"
					aria-labelledby="ProdukModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-dialog-scrollable modal-xs">
						<div class="modal-content">
							<div class="modal-header">
								<h3 class="modal-title fs-5" id="ProdukModalLabel">Edit Produk</h3>
								<button type="button" class="btn-close" data-dismiss="modal"
									aria-label="Close"></button>
							</div>
							<div class="modal-body">
									...
									<form method="post" action="<?= base_url('Produk/ProsesEdit') ?>">
										...
										<div class="card-body">
											<div class="mb-3">
												...
												<input type="text" class="form-control" value="<?= $p->NamaProduk ?>"
													name="NamaProduk" />
												<?= form_error('NamaProduk', '<small class="text-danger">', '</small>') ?>
											</div>
											<div class="mb-3">
